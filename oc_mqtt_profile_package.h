...
/* ==================== 修改为你自己的华为云信息 ==================== */
/* 华为云标准版实例接入地址（从控制台获取） */
#define OC_SERVER_URL           "tcp://19f38e9f61.st1.iotda-device.cn-north-4.myhuaweicloud.com:1883"
#define OC_SERVER_IP            "19f38e9f61.st1.iotda-device.cn-north-4.myhuaweicloud.com"
